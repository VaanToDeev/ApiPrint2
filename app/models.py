from sqlalchemy import Column, DateTime, Integer, String, Enum as SAEnum, ForeignKey
...
class Professor(Base):
    ...
    orientandos = relationship("Estudante", back_populates="orientador")
    orientacoes_tcc = relationship("TCC", back_populates="orientador")  # Adicionado para TCCs orientados
...
class Estudante(Base):
    ...
    telefone = Column(String(20), nullable=True) # NOVO CAMPO: Telefone
    orientador_id = Column(Integer, ForeignKey("professores.id"), nullable=True)
    orientador = relationship("Professor", back_populates="orientandos")

    curso_id = Column(Integer, ForeignKey("cursos.id_curso"))
    curso = relationship("Curso", back_populates="estudantes")
    tccs = relationship("TCC", back_populates="estudante")  # Adicionado para TCCs do estudante
